...
class list_projects_pdf(list_projects_pdfTemplate):
  def __init__(self, dicts, field_parameters,  **properties):
    ...
    self.category_label.text = field_parameters[0]
    self.average_completion_label.text = field_parameters[1]
    self.work_to_do_label.text = field_parameters[2]
    self.total_value_label.ttext =field_parameters[3]
    self.text_box_1.text =field_parameters[4]
