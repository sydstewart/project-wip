from ._anvil_designer import active_projects_by_board_stage_listTemplate
from anvil import *
import anvil.users
import anvil.server
...
class active_projects_by_board_stage_list(active_projects_by_board_stage_listTemplate):
  def __init__(self, project_board, new_column, **properties):
